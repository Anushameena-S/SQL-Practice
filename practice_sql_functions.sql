USE hr_emp;
-- Function or Operations are classified as Unary and Binary
-- To perform Unary operation, atleast one table is required - String, Numeric and Date functions.
-- To perform Binary operations, atleast 2 tables are required - Set Operations and Joins
-- -------------------------------------
-- String functions
-- -------------------------------------
...
-- concat strings
-- all select statements are only for display purpose, it will not affect db value
...
-- ACOS() - The ACOS() function returns the arc cosine of a number.
-- ATAN() - The ATAN() function returns the arc tangent of a number.
